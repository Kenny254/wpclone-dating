        ...
        <div class="col-md-3">
            <div class="box same-height" style="background: #2072bc;">
                <form>
                    <div class="row CC">
                        <div class="col-md-12">
                            <img class="img-circle img-responsive" src="/uploads/profiles/{{$user->profilepicurl}}" alt="">
                        </div>
                    ...
                    {!! Form::model($user, ['route' => 'frontend.user.profile.update', 'class' => 'form-horizontal', 'method' => 'PATCH']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="name" name="name" class="form-control" placeholder="{{$user->name}}">
                            </div>
                        </div>

                        <div class="form-group">
                            {!! Form::label('name', 'Summery ', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                                
                                <input type="text" value="{{$user->summery}}" name="summery" class="form-control" placeholder="{{$user->summery}}" maxlength="75">
                            </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="gender">
                            <option value="{{$user->summery}}">{{$user->gender}}</option>
                        ...
                        <div class="form-group">
                            {!! Form::label('name', 'Location ', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
