...
<div class="container">
    ...
    <div class="row" Style="margin-top: 10px;">
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-9">
                <p Style="font-size: 20px; color: #8a8a8a;">{{ \auth::user()->name }}</p>
            </div>

        </div>
        <div class="col-md-8">
            <p Style="color: #8a8a8a; margin-top: 5px;">{{ \auth::user()->created_at }}</p>
        </div>
    </div>
    <!--This is a comment. Comments are not displayed in the browser-->
    <div class="row" Style="margin-top: 15px; background-color: #eaf4fb">
        ...
        <div class="col-md-9">
            ...
            <p Style="color: #8a8a8a; margin-top: 7px; font-size: 17;  text-align: justify;">{{ \auth::user()->description }}</p>
        </div>
    </div>
</div>
